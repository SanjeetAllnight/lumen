      ...
      <div className="grid grid-cols-12 gap-8 mb-12">
        ...
        <section className="col-span-12 lg:col-span-4 flex flex-col gap-6">
          ...
          <div className="glass-panel rounded-3xl p-6 border border-white/5 relative overflow-hidden group transition-all duration-300 glow-hover">
            ...
            <div className="relative z-10">
              <span className="text-xs font-headline tracking-widest text-primary uppercase block mb-2">Pulse Check</span>
          ...
          <div className="glass-panel rounded-3xl p-8 border border-white/5 relative overflow-hidden transition-all duration-300 glow-hover">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-2 mb-6">
                ...
                <h3 className="text-lg font-headline font-bold text-on-surface">Predictive Pulse</h3>
              </div>
