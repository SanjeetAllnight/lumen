  ...
  return (
    <div className="px-8 pb-12 w-full">
      ...
      <div className="flex justify-between items-end mb-10">
        ...
        <button className="flex items-center gap-2 bg-gradient-to-br from-primary to-primary-container text-on-primary-container px-6 py-3.5 rounded-full font-headline font-bold text-sm tracking-wide shadow-[0_0_30px_-5px_rgba(199,153,255,0.5)] active:scale-95 transition-all">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
          ...
          <div className="glass-panel p-8 rounded-[2.5rem] border-[3px] border-error/40 relative overflow-hidden card-interaction-hover bg-gradient-to-br from-error/10 via-surface-container/50 to-surface-container shadow-2xl shadow-error/10">
            ...
            <div className="flex flex-wrap items-center justify-between gap-6 pt-8 border-t border-outline-variant/20">
              <div className="flex items-center gap-8">
                {/* Large Upvote */}
                <button className="flex items-center gap-4 px-10 py-5 rounded-2xl bg-primary text-on-primary font-bold transition-all hover:scale-105 active:scale-95 shadow-[0_0_30px_-5px_rgba(199,153,255,0.8)]">
                  <span className="material-symbols-outlined text-2xl" style={{ fontVariationSettings: "'FILL' 1" }}>thumb_up</span>
                  <span className="text-2xl">342</span>
                </button>
                {/* Badge */}
                <div className="flex flex-col">
                  <span className="text-[10px] font-bold text-on-surface-variant uppercase tracking-widest mb-1">Impact Level</span>
                  <span className="text-lg font-black uppercase tracking-tight text-on-surface"><span className="text-error">450</span> STUDENTS AFFECTED</span>
                </div>
              </div>
        ...
        <div className="xl:col-span-4 grid grid-cols-1 gap-6">
          ...
          <div className="glass-panel p-6 rounded-[2rem] border border-outline-variant/10 bg-primary/5">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h4 className="font-headline font-bold text-sm tracking-wide">Pulse Insight</h4>
            </div>
          ...
          <div className="glass-panel p-6 rounded-[2.5rem] border border-outline-variant/20 h-full flex flex-col card-interaction-hover group bg-surface-container/30">
            ...
            <div className="mt-auto pt-6 border-t border-outline-variant/10 flex flex-col gap-6">
              <div className="flex items-center justify-between">
                <button className="flex items-center gap-3 px-6 py-3 rounded-xl bg-tertiary/10 hover:bg-tertiary/20 text-tertiary transition-all shadow-lg shadow-tertiary/5 border border-tertiary/20">
                ...
                <span className="text-[11px] font-black uppercase tracking-tighter text-on-surface-variant">88 STUDENTS AFFECTED</span>
              </div>
              <div className="flex items-center justify-between">
        ...
        <div className="xl:col-span-4">
          <div className="glass-panel p-6 rounded-[2.5rem] border border-outline-variant/20 h-full flex flex-col card-interaction-hover group bg-surface-container/30">
            ...
            <div className="mt-auto pt-6 border-t border-outline-variant/10 flex flex-col gap-6">
              <div className="flex items-center justify-between">
                <button className="flex items-center gap-3 px-6 py-3 rounded-xl bg-secondary/10 hover:bg-secondary/20 text-secondary transition-all shadow-lg shadow-secondary/5 border border-secondary/20">
                  <span className="material-symbols-outlined text-lg" style={{ fontVariationSettings: "'FILL' 1" }}>thumb_up</span>
                  <span className="text-lg font-bold">12</span>
                </button>
                <span className="text-[11px] font-black uppercase tracking-tighter text-on-surface-variant">12 STUDENTS AFFECTED</span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="flex gap-2 bg-black/20 p-1.5 rounded-lg">
        ...
        <div className="xl:col-span-4">
          <div className="glass-panel p-6 rounded-[2.5rem] border border-outline-variant/20 h-full flex flex-col card-interaction-hover group bg-surface-container/30">
            ...
            <div className="mt-auto pt-6 border-t border-outline-variant/10 flex flex-col gap-6">
              <div className="flex items-center justify-between">
                <button className="flex items-center gap-3 px-6 py-3 rounded-xl bg-error/10 hover:bg-error/20 text-error transition-all shadow-lg shadow-error/5 border border-error/20">
                  <span className="material-symbols-outlined text-lg" style={{ fontVariationSettings: "'FILL' 1" }}>thumb_up</span>
                  <span className="text-lg font-bold">45</span>
                </button>
                <span className="text-[11px] font-black uppercase tracking-tighter text-on-surface-variant">45 STUDENTS AFFECTED</span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="flex gap-2 bg-black/20 p-1.5 rounded-lg">
